...
import { navMeuns, siteMenus }        from "@/layouts/components/vertical-nav-menu/navMenuItems.js"
...
export default {
  ...
  methods: {
    ...
    updateNavbar(val) {
      ...
      this.navbarType = val
      this.$store.dispatch('app/updateNavbarType', val)
    },
