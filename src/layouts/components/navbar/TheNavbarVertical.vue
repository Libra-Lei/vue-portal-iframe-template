...
<div class="relative">
  <div class="vx-navbar-wrapper" :class="classObj" style="height:auto;">
    <vs-navbar class="vx-navbar navbar-custom navbar-skelton" :color="navbarColorLocal">
      ...
      <!-- <vs-button color="primary" type="border" @click="testBtn">测试</vs-button>
      <vs-button color="primary" type="border" @click="testBtnUser">测试用户</vs-button> -->
      ...
      <!-- USER META -->
      <div class="the-navbar__user-meta flex items-center" v-if="activeUserInfo.sub">
...
// import { test, info } from '../../../api/user'
