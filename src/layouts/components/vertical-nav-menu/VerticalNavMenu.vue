      ...
      <div class="relative" @mouseenter="mouseEnter" @mouseleave="mouseLeave">
        ...
        <div class="header-sidebar flex items-end justify-between" slot="header">
          ...
          <router-link tag="div" class="vx-logo cursor-pointer flex items-center" to="/">
            ...
            <span class="vx-logo-text max-w-40 truncate" :title="title" v-show="isMouseEnter || !reduce" v-if="title">{{ title }}</span>
          </router-link>
          <!-- /Logo -->
...
// 左下角菜单-其他内容
import Copyright from '@/layouts/system-menu/Copyright'
import NotifyAndHelp from '@/layouts/system-menu/NotifyAndHelp'
...
export default {
  ...
  props: {
    ...
    siteMenusItems:   { type: Array, required: true }
  },
  data: () => ({
